...
def main():
    ...
    # Réglez la largeur et la hauteur de l'écran [width, height].
    ...
    # Permet de gérer la vitesse de mise à jour de l'écran
    ...
    while not done:
        ...
        # raiter les événements (frappes au clavier, clics de souris, etc.)
